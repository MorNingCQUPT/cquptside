...
<div class="doc-content">
    <div class="container doc-container doc-t30">
        <div class="row">
			<div style="width:100%;">
            ...
            <div class="span4">
				...
				<div class="doc-content" id="linkList">
					...
					<ul class="doc-span-ul doc-bg">
						<li><a href="http://202.202.43.125">红岩网校</a></li>
						<li><a href="http://crad.ict.ac.cn/">计算机研究与发展</a></li>
						<li><a href="http://www.acm.org/">美国计算机协会ACM</a></li>
						<li><a href="http://202.202.43.2/web">红星网络</a></li>
						<li><a href="http://cjc.ict.ac.cn/">计算机学报</a></li>
						<li><a href="http://www.cernet.edu.cn/">教育科研网</a></li>
					</ul>
				</div>
            </div>
        </div>
