                ...
                <div class="span3">
                    ...
                    <ul class="doc-span-ul doc-bg">
                        <!--循环体
                            ...
                            度参差不齐。。。
                        -->
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="#"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        <!--循环体结束-->
                    </ul>
                </div>
                <!--文章列表结束-->
